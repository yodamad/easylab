...
func TestGitCloneInit_WithoutAuth(t *testing.T) {
	...
	c := gitCloneInit("https://gitlab.com/org/public.git", "main", "/home/workspace", "/home/workspace", "", false)
...
func TestGitCloneInit_WithAuth(t *testing.T) {
	...
	c := gitCloneInit("https://gitlab.com/org/private.git", "main", "/home/workspace", "/home/workspace", "gitcred", false)
...
func TestGitCloneInit_ScriptIsValidSh(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			c := gitCloneInit(tt.repo, tt.branch, "/home/workspace", "/home/workspace", tt.authSecret, false)
			require.Len(t, c.Command, 3)
